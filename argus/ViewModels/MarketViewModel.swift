...
final class MarketViewModel: ObservableObject {
    ...
    func fetchQuotes() async {
        ...
        // Abdullah PR #22: HeimdallOrchestrator.requestQuotesBatch
        // (Stooq tek HTTP çağrısında 80 sembol) tier'lı chunked yaklaşımı
        // gereksizleştirdi — 304 sembol için 76 değil 4 istek.
